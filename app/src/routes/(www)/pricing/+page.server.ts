 ...
 *
 * Reads pricing directly from gosaas.yaml at build time.
...
function loadPricingFromYaml(): PricingProduct[] {
	...
	try {
		...
		console.error('Failed to load pricing from gosaas.yaml:', error);
		return [];
	}
}
