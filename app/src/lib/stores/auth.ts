...
import * as api from '$lib/api/gosaas';
import type { User, LoginRequest, RegisterRequest, LoginResponse } from '$lib/api/gosaasComponents';
...
// Token storage keys
const TOKEN_KEY = 'gosaas_token';
const REFRESH_TOKEN_KEY = 'gosaas_refresh_token';
const EXPIRES_AT_KEY = 'gosaas_expires_at';
const USER_KEY = 'gosaas_user';
