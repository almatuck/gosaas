...
**Note**: Levee is an **optional** mode. By default, GoSaaS runs in standalone mode with SQLite and direct Stripe integration. Use Levee mode when you need managed platform features like email sequences, CMS, and AI gateway.
