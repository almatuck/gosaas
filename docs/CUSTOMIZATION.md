...
How to customize GoSaaS for your brand and product.

## Configuration System

GoSaaS uses a 3-file configuration system:

| File | Purpose | When to Edit |
|------|---------|--------------|
| `app/src/lib/config/site.ts` | Branding, SEO, social links | Rebrand your product |
| `etc/gosaas.yaml` | Products, pricing, backend settings | Change pricing, features |
...
Products are defined in `etc/gosaas.yaml`:
