...
# Default target
help:
	@echo "GoSaaS - Full-stack SaaS Boilerplate"
	@echo ""
	@echo "Quick Start:"
...
dev:
	@echo "Starting GoSaaS development environment..."
...
setup:
	...
	@echo "Renaming project from gosaas to $(NAME)..."
	@./install.sh $(NAME)
...
docker-run:
	...
	docker run -p 8888:8888 --env-file .env $(EXECUTABLE)
